...
from libc.stdio cimport stdout, FILE, printf, fprintf
...
cdef extern from "mpfr.h":
    ...
    int mpfr_add_si (mpfr_t, mpfr_t, long int, mpfr_rnd_t)
    int mpfr_sub_si (mpfr_t, mpfr_t, long int, mpfr_rnd_t)
    int mpfr_mul_si (mpfr_t, mpfr_t, long int, mpfr_rnd_t)
    int mpfr_div_si (mpfr_t, mpfr_t, long int, mpfr_rnd_t)
    int mpfr_si_sub (mpfr_t, long int, mpfr_t, mpfr_rnd_t)
    int mpfr_si_div (mpfr_t, long int, mpfr_t, mpfr_rnd_t)
