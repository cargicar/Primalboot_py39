/* S. Rychkov May 2013 */
/* LU decomposition code based on Numerical Rreciped 3rd ed. but turned into mpfr_t and C
See also NR 2nd ed. where a different loop order is used  */
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
#include <gmp.h>
...
int inverse(mpfr_t *a, int n, mpfr_t *y, mpfr_t* lu)
/* returns y as the inverse matrix */
/* a is not destroyed */
/* lu is a scratch matrix */
{
    int i,j;
    /* mpfr_t *lu;*/
    int *indx;
